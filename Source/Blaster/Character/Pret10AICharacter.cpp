...
#include "Pret10AICharacter.h"
#include "Components/BoxComponent.h"
#include "GameFramework/CharacterMovementComponent.h"
#include "Blaster/Blaster.h"

APret10AICharacter::APret10AICharacter()
{
...
UBoxComponent* APret10AICharacter::GetHeadBox()
{
	return HitCollisionBoxes[HeadName];
}

void APret10AICharacter::SetAILevel(int Level)
{
